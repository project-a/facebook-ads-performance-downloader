...
A Python script for downloading structure and performance data from ad accounts in a single [business manager](https://developers.facebook.com/docs/apps/business-manager) using the Facebook Ads API ([v3.1](https://developers.facebook.com/docs/marketing-api/reference/v3.1)) to local files. 
